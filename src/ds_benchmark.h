...
#define DEFINE_TIMER_VARIABLES                                                 \
	...
	double _bench_time_x, _bench_time_mean, _bench_time_delta, _bench_time_M2, \
		_bench_time_stdev, _bench_time_cumulative;
...
#define PRINT_TIMER_HEADER                                                     \
	printf("%-30s %15s %15s %15s %15s %15s %15s\n", "Operation", "Iterations", \
		   "Total time (s)", "Time(us): mean", "pop. stdev", "Cycles: mean",   \
		   "pop. stdev");

#define PRINT_TIMER_AVG(op_name)                                             \
	printf("%-30s %15" PRIu64 " %15.3f %15.3f %15.3f %15.0f %15.0f\n",       \
		   (op_name), _bench_iterations, _bench_time_cumulative / 1000000.0, \
		   _bench_time_mean, _bench_time_stdev,                              \
